...
public class MaterialTest {
    ...
    public void testIfMeterConvertsToFeet(){
        ...
        assertEquals((new Feet(3.28084)).converToCentimeters(), quantity.convertTo(meter, feet).converToCentimeters(),0.00001);  
    }
    ...
    public void testIfMeterConvertsToInch(){
        ...
        assertEquals((new Inch(39.3701)).converToCentimeters(), quantity.convertTo(meter, inch).converToCentimeters(),0.0001);  
    }
